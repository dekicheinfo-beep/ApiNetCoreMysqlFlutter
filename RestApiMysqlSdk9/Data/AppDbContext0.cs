...
public partial class AppDbContext0 : DbContext
{
    public AppDbContext0()
    {
    }

    public AppDbContext0(DbContextOptions<AppDbContext0> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;port=3306;database=db_atelier;user=root;pwd=0000", Microsoft.EntityFrameworkCore.ServerVersion.Parse("5.7.21-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EntLigneProforma>(entity =>
        {
            ...
            entity.ToTable("ent_ligne_proforma");
        ...
        modelBuilder.Entity<EntLigneTravail>(entity =>
        {
            ...
            entity.ToTable("ent_ligne_travail");
        ...
        modelBuilder.Entity<EntReservation>(entity =>
        {
            ...
            entity.ToTable("ent_reservation");
        ...
        modelBuilder.Entity<EntVehiculeImage>(entity =>
        {
            ...
            entity.ToTable("ent_vehicule_image");
